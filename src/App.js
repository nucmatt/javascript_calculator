...
function App() {
	...
	const secondaryFuncs = [
		...
		{ id: 'clear', value: 'C', actionType: 'CLEAR_ALL', keyCode: 127 },
	];
	const numbpadBtns = [
		{ id: 'open-parentheses', value: '(', actionType: 'OPENPAREN_INPUT', keyCode: 40 },
		{ id: 'seven', value: '7', actionType: 'UPDATE_EQN', keyCode: 55 },
		{ id: 'eight', value: '8', actionType: 'UPDATE_EQN', keyCode: 56 },
		{ id: 'nine', value: '9', actionType: 'UPDATE_EQN', keyCode: 57 },
		{ id: 'divide', value: '/', actionType: 'OPERATOR_INPUT', keyCode: 47 },
		{ id: 'close-parentheses', value: ')', actionType: 'OPERATOR_INPUT', keyCode: 41 },
		{ id: 'four', value: '4', actionType: 'UPDATE_EQN', keyCode: 52 },
		{ id: 'five', value: '5', actionType: 'UPDATE_EQN', keyCode: 53 },
		{ id: 'six', value: '6', actionType: 'UPDATE_EQN', keyCode: 54 },
		{ id: 'multiply', value: '*', actionType: 'OPERATOR_INPUT', keyCode: 42 },
		{ id: 'exponent', value: '^', actionType: 'OPERATOR_INPUT', keyCode: 94 },
		{ id: 'one', value: '1', actionType: 'UPDATE_EQN', keyCode: 49 },
		{ id: 'two', value: '2', actionType: 'UPDATE_EQN', keyCode: 50 },
		{ id: 'three', value: '3', actionType: 'UPDATE_EQN', keyCode: 51 },
		{ id: 'subtract', value: '-', actionType: 'OPERATOR_SUBTRACT', keyCode: 45 },
		{ id: 'backspace', value: 'BS', keyCode: 8 },
		{ id: 'zero', value: '0', actionType: 'ZERO_INPUT', keyCode: 48 },
		{ id: 'decimal', value: '.', actionType: 'DECIMAL_INPUT', keyCode: 46 },
		{ id: 'equals', value: '=', actionType: 'SOLVE_EQN', keyCode: 61 },
		{ id: 'add', value: '+', actionType: 'OPERATOR_INPUT', keyCode: 43 },
	];
	return (
